GLaDOS Text-to-speech (TTS) Voice Generator MEETS a chatbot
...
The result is a HUMAN INTERFACE CONSOLE that allows users to talk to GLADOS!
Runs perfectly on linux, but you must download the necessary libraries. 
