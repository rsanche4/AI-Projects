...
BEGINNINGS = ["yeah", "umm...", "i mean", "like", "uwu", "lol", "hey", "yeah so", ". . .", "uh"]
ENDINGS = [":)", ":-)", "lol", ". . .", ";)", "(>.<)", ">_<", "hehehe", "hehe", "heeheehee", "heehee", "hahaha", "haha", "lmao", "lmaoo", "lmaooo", "yeah?", "also, ily", "omg", "tho", "uwu"]
WITH_FREQ = 1
...
async def on_message(message):
    ...
    if message.guild and random.randint(0, POST_RATE)==0:
        ...
        if random.randint(0, WITH_FREQ)==0:
            msg = msg + " " + random.choice(BEGINNINGS)
